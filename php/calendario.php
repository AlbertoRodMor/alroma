...
<body>
	...
	<script type="text/javascript">
		...
		jQuery('#popupbicisdisponibles').ready(function(){
			...
			//jQuery(".fc-daygrid-day .ocupado").each(function(){
				...
				jQuery(".fc-daygrid-body table").on('click','.fc-daygrid-day-frame',function(){

					var fechaclickada = jQuery(this).parent().attr("data-date");
					...
					$.ajax({
						...
						url : url,
						dataType: 'json',
						data : {'fechaSeleccionada' : fechaclickada},
    ...
    console.log("paso4");
    jQuery("input[name='fechaClickada']").val(fechaclickada);
