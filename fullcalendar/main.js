...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    var DAY_FORMAT = createFormatter({ year: 'numeric', month: 'numeric', day: 'numeric' });
    var WEEK_FORMAT = createFormatter({ week: 'numeric' });
    ...
    */
    /*ARRAY QUE GUARDA LOS DÍAS OCUPADOS*/
        ...
        var widgets = sectionSubstrs.map(function (buttonGroupStr) { return (buttonGroupStr.split(',').map(function (buttonName) {
            ...
            jQuery(".fc-daygrid-day").each(function(){
                ...
                if(jQuery(this).find(".ocupado").length>0){
                    ...
                    for(var i=0; i<jQuery(this).find(".ocupado").length; i++){

                        arrayFechas[i] = jQuery(this).attr("data-date");
                        console.log('Fechas'+ arrayFechas[i]);
                    }
            ...
            for(var i=0; i<arrayFechas.length; i++){
                ...
                jQuery(".fc-daygrid-day[data-date='"+arrayFechas[i]+"'] > div").append("<span class=\'ocupado\'>*</span>");
                        console.log('Fechas'+ arrayFechas[i]);
            }
