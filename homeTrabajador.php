											...
											<form action='<?php echo $_SERVER['PHP_SELF']; ?>' method='POST' id='formulario_insertar_trabajador'>
												<table id="tablaTrabajadores" class="">
													<tbody>	
														...
														<tr>
															<td class="p-2"><input type="text" name="insertNombreTr" class="insertNombreTr" required="required"></td>
															<td class="p-2"><input type="text" name="insertApellTr" class="insertApellTr" required="required"></td>
															<td class="p-2"><input type="text" name="insertUsuarioTr" class="insertUsuarioTr" minlength="8" maxlength="8" required="required"></td>
															<td class="p-2"><input type="text" name="insertPassTr" class="insertPassTr" minlength="8" maxlength="8" required="required"></td><td class="p-2"><button class="boton_anadir_trabajador"><img src="img/mas.png"></button></td>
														</tr>
													</tbody>	
												</table>		
											</form>
