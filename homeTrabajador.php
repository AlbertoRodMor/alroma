							...
							<!-- <div class="col">
								...
								<div class="d-none" id="facturas">
									<div class="card card-body tarjeta2">
										...
										<button class="crear_facturas btn btn-primary">CREAR FACTURAS</button>
											...
											<div class="col-12">
												...
												<form action='php/facturas.php' method='POST' id="form_crear_factura">
													...
													<label for="total">TOTAL DE LA FACTURA</label>
														...
														<button class="mt-4 insertar_facturas btn btn-primary mr-3">INSERTAR FACTURAS</button>
									...
									<div class="card card-body">
										<?php 
											$pdo = conexion();
											$sqlVerAlquileres = "SELECT * FROM alquiler_bicis";
